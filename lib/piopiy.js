...
var _default = exports["default"] = /*#__PURE__*/function (_EventEmitter) {
  ...
  return _createClass(_default, [{
    ...
    key: "transfer",
    value: function transfer(to, callback) {
      var _this = this;
      if (!_this.socketCMI) {
        if (typeof callback === 'function') {
          callback({
            error: "SocketCMI is not initialized"
          });
        }
        return;
      }
      _this.socketCMI.transfer(userAgent.getCallId(_this), to, function (data) {
        if (typeof callback === 'function') {
          callback(data);
        }
      });
